...
def parse_args():
    ...
    parser.add_argument('--data_dir', default='../data/D2/res16', help='data directory.')
    parser.add_argument('--vocab_dir', default='../data/D2/res16', help='Output vocab directory.')
...
def main():
    ...
    # postag_ca
    vocab_postag_ca_file = args.vocab_dir + '/vocab_postag_ca.vocab'
    # load files
    print("loading files...")
    ...
    # postag_ca
    postag_ca_vocab = VocabHelp(postag_ca_counter, specials=['<pad>', '<unk>'])
    print("token_vocab: {}, post_vocab: {}, syn_post_vocab: {}, deprel_vocab: {}, postag_vocab: {}, postag_ca_vocab: {}".format(len(token_vocab), len(post_vocab), len(syn_post_vocab), len(deprel_vocab), len(postag_vocab), len(postag_ca_vocab)))
    ...
    postag_ca_vocab.save_vocab(vocab_postag_ca_file)
    print("all done.")
